...
AURALIS_OWNER_PRIVATE_KEY="${PRIVATE_KEY:?Set PRIVATE_KEY to a funded local Anvil account key before running Auralis scripts.}"
AURALIS_ALICE_PRIVATE_KEY="${ALICE_PRIVATE_KEY:?Set ALICE_PRIVATE_KEY to a second funded local Anvil account key before running Auralis scripts.}"
